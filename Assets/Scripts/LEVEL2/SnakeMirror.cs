...
public class SnakeMirror : MonoBehaviour
{
    ...
    private class SnakeBodyPart
    {
        ...
        {
            GameObject snakeBodyPartGameObject = new GameObject("Snake Body Mirror",
    ...
    public void Setup(LevelGridMirror levelGrid)
    {
        // levelGrid de snake = levelGrid que viene por parámetro
        this.levelGridMirror = levelGrid;
    }
    ...
    private void HandleGridMovement() // Relativo al movimiento en 2D
    {
        ...
        if (gridMoveTimer >= gridMoveTimerMax)
        {
            ...
            gridPosition = levelGridMirror.ValidateGridPosition(gridPosition);
            
            // ¿He comido comida?
            bool snakeAteFood = levelGridMirror.TrySnakeEatFood(gridPosition);
            if (snakeAteFood)
            {
                // El cuerpo crece
                snakeBodySize++;
