...
public class LevelGridMirror
{
    ...
    public LevelGridMirror(int w, int h)
    {
        width = w;
        height = h;
    }

    public void Setup(SnakeMirror snake)
    {
        this.snakeMirror = snake;
        SpawnFood();
    }
    ...
    private void SpawnFood()
    {
        ...
        } while (snakeMirror.GetFullSnakeBodyGridPosition().IndexOf(foodGridPosition) != -1);
